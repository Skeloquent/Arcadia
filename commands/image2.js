...
module.exports.run = async (client, message, args) => {
  ...
  console.log(`# Command used: ${client.clientconfig.prefix}image2 || In ${message.guild.name}`);
  ...
  if((message.attachments).array()[0]) {
    ...
    if(!client.Users[game][player]) {
      client.Users[game][player]= {
        ...
        flex_time: "",
        image: "",
        image2: message.attachments.array()[0].url,
        flex: "",
      ...
      client.Users[game][message.author.id].image2=(message.attachments).array()[0].url
    client.Users[game][message.author.id].time2=day
    message.react('✅')
    if(client.Users[game][player]) {
