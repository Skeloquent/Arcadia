...
module.exports.run = async (client, message, args) => {
  ...
  console.log(`# Command used: ${clientconfig.prefix}footer || In ${message.guild.name}`);
  ...
  if(name!="") {
    ...
    return message.channel.send(`${client.GameNames[game]}, please provide footer text for your ${client.GuildPrefix[message.guild.id].prefix}profile.\nEx:\n> ${client.GuildPrefix[message.guild.id].prefix}footer I <3 Whale-kuns\n\nTo clear a footer, please do:\n> ${client.GuildPrefix[message.guild.id].prefix}reset_footer`)
  }
    ...
    if(!client.Users[game][player]) {
      ...
      return
        ...
        client.Users[game][player].flavor=name
        message.react('✅')
        return
    }
...
module.exports.help = {
  name: "footer",
  usage: `footer`,
  desc: "Adds flavor text to your profile",
  public: true
